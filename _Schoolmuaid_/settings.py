"""
Django settings for _Schoolmuaid_ project.
...
ROOT_URLCONF = '_Schoolmuaid_.urls'
...
WSGI_APPLICATION = '_Schoolmuaid_.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, '_Schoolmuaid_/static/'),
]
